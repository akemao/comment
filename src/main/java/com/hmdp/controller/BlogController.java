...
public class BlogController {
    ...
    @GetMapping("/of/user")
    public Result queryBlogsByIds(@RequestParam("id") Long userId,@RequestParam("current") Integer current){
        return blogService.queryBlogsByIds(userId,current);
    }

    @RequestMapping("/of/follow")
